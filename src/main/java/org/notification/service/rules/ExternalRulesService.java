...
@Component
public class ExternalRulesService implements Rules{
    private final static Logger logger = LoggerFactory.getLogger(ExternalRulesService.class);
    final String RULE_NAME = "ExternalRulesService";
    @Override
